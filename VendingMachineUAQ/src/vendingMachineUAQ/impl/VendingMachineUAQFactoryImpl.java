...
public class VendingMachineUAQFactoryImpl extends EFactoryImpl implements VendingMachineUAQFactory {
	...
	public static VendingMachineUAQFactory init() {
		try {
			VendingMachineUAQFactory theVendingMachineUAQFactory = (VendingMachineUAQFactory)EPackage.Registry.INSTANCE.getEFactory(VendingMachineUAQPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case VendingMachineUAQPackage.VENDING_MACHINE: return createVendingMachine();
			case VendingMachineUAQPackage.LOCATION: return createLocation();
			case VendingMachineUAQPackage.KEYPAD: return createKeypad();
			case VendingMachineUAQPackage.HAS_OPERATION: return createHasOperation();
			case VendingMachineUAQPackage.ITEM_PROCESSOR: return createItemProcessor();
			case VendingMachineUAQPackage.STATE: return createState();
			case VendingMachineUAQPackage.PAYMENT_PROCESSOR: return createPaymentProcessor();
			case VendingMachineUAQPackage.ITEM_GROUP: return createItemGroup();
			case VendingMachineUAQPackage.ITEM: return createItem();
			case VendingMachineUAQPackage.INVENTORY: return createInventory();
			default:
