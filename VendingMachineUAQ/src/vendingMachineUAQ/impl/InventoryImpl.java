...
public class InventoryImpl extends HasIdImpl implements Inventory {
	...
	public EList<ItemGroup> getItemGroups() {
		if (itemGroups == null) {
			itemGroups = new EObjectContainmentEList<ItemGroup>(ItemGroup.class, this, VendingMachineUAQPackage.INVENTORY__ITEM_GROUPS);
		}
		return itemGroups;
	}
	...
	public void setCapacity(int newCapacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VendingMachineUAQPackage.INVENTORY__CAPACITY, oldCapacity, capacity));
	}
	...
	public void setLastRestocked(Date newLastRestocked) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VendingMachineUAQPackage.INVENTORY__LAST_RESTOCKED, oldLastRestocked, lastRestocked));
	}
	...
	public void setAvailableSlots(int newAvailableSlots) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VendingMachineUAQPackage.INVENTORY__AVAILABLE_SLOTS, oldAvailableSlots, availableSlots));
	}
	...
	public float calculateTotalValue() {
		...
		final /*@NonInvalid*/ OrderedSetValue BOXED_itemGroups = idResolver.createOrderedSetOfAll(VendingMachineUAQTables.ORD_CLSSid_ItemGroup, itemGroups);
		/*@Thrown*/ Accumulator accumulator = ValueUtil.createSequenceAccumulatorValue(VendingMachineUAQTables.SEQ_PRIMid_Real);
	...
	public boolean NonNegativeCapacity(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			 ...
			 */
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this);
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, VendingMachineUAQPackage.Literals.INVENTORY___NON_NEGATIVE_CAPACITY__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				final /*@NonInvalid*/ boolean result = OclComparableGreaterThanEqualOperation.INSTANCE.evaluate(executor, BOXED_capacity, VendingMachineUAQTables.INT_0).booleanValue();
