...
public class PaymentProcessorImpl extends HasOperationImpl implements PaymentProcessor {
	...
	public void setAmound(float newAmound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VendingMachineUAQPackage.PAYMENT_PROCESSOR__AMOUND, oldAmound, amound));
	}
	...
	public void setPaymentMethod(PAYMENT_METHODS newPaymentMethod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VendingMachineUAQPackage.PAYMENT_PROCESSOR__PAYMENT_METHOD, oldPaymentMethod, paymentMethod));
	}
	...
	public State getState() {
		if (state != null && state.eIsProxy()) {
			...
			if (state != oldState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VendingMachineUAQPackage.PAYMENT_PROCESSOR__STATE, oldState, state));
			}
		}
		return state;
	}
	...
	public void setState(State newState) {
		...
		state = newState;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VendingMachineUAQPackage.PAYMENT_PROCESSOR__STATE, oldState, state));
	}
	...
	public boolean isPaymentComplete() {
		...
		final /*@NonInvalid*/ EnumerationLiteralId BOXED_stage = VendingMachineUAQTables.ENUMid_STATES.getEnumerationLiteralId(ClassUtil.nonNullState(stage.getName()));
		...
		if (and == null) {
			throw new InvalidValueException("Null body for \'vendingMachineUAQ::PaymentProcessor::isPaymentComplete() : Boolean[1]\'");
		}
		return and;
	}
