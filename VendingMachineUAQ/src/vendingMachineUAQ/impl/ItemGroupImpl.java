...
public class ItemGroupImpl extends HasIdImpl implements ItemGroup {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VendingMachineUAQPackage.ITEM_GROUP__NAME, oldName, name));
	}
	...
	public void setQuantity(int newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VendingMachineUAQPackage.ITEM_GROUP__QUANTITY, oldQuantity, quantity));
	}
	...
	public void setPrice(float newPrice) {
		...
		price = newPrice;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VendingMachineUAQPackage.ITEM_GROUP__PRICE, oldPrice, price));
	}
	...
	public void setImage(String newImage) {
		...
		image = newImage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VendingMachineUAQPackage.ITEM_GROUP__IMAGE, oldImage, image));
	}
	...
	public EList<Item> getItems() {
		if (items == null) {
			items = new EObjectContainmentWithInverseEList<Item>(Item.class, this, VendingMachineUAQPackage.ITEM_GROUP__ITEMS, VendingMachineUAQPackage.ITEM__ITEM_GROUP);
		}
		return items;
	}
	...
	public boolean PositiveQuantity(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, VendingMachineUAQPackage.Literals.ITEM_GROUP___POSITIVE_QUANTITY__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, VendingMachineUAQTables.INT_0).booleanValue();
			...
			if (le) {
				...
				final /*@NonInvalid*/ boolean result = OclComparableGreaterThanOperation.INSTANCE.evaluate(executor, BOXED_quantity, VendingMachineUAQTables.INT_0).booleanValue();
				final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, constraintName, this, (Object)null, diagnostics, context, (Object)null, severity_0, result, VendingMachineUAQTables.INT_0).booleanValue();
				IF_le = logDiagnostic;
			}
			return IF_le;
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedEntity.class) {
			switch (derivedFeatureID) {
				case VendingMachineUAQPackage.ITEM_GROUP__NAME: return VendingMachineUAQPackage.NAMED_ENTITY__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedEntity.class) {
			switch (baseFeatureID) {
				case VendingMachineUAQPackage.NAMED_ENTITY__NAME: return VendingMachineUAQPackage.ITEM_GROUP__NAME;
				default: return -1;
			}
		}
