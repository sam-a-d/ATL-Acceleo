...
public class ItemImpl extends HasIdImpl implements Item {
	...
	public void setExpiry(Date newExpiry) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VendingMachineUAQPackage.ITEM__EXPIRY, oldExpiry, expiry));
	}
	...
	public ItemGroup getItemGroup() {
		if (eContainerFeatureID() != VendingMachineUAQPackage.ITEM__ITEM_GROUP) return null;
	...
	public void setItemGroup(ItemGroup newItemGroup) {
		if (newItemGroup != eInternalContainer() || (eContainerFeatureID() != VendingMachineUAQPackage.ITEM__ITEM_GROUP && newItemGroup != null)) {
			...
			if (newItemGroup != null)
				msgs = ((InternalEObject)newItemGroup).eInverseAdd(this, VendingMachineUAQPackage.ITEM_GROUP__ITEMS, ItemGroup.class, msgs);
			msgs = basicSetItemGroup(newItemGroup, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VendingMachineUAQPackage.ITEM__ITEM_GROUP, newItemGroup, newItemGroup));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case VendingMachineUAQPackage.ITEM__ITEM_GROUP:
				return eInternalContainer().eInverseRemove(this, VendingMachineUAQPackage.ITEM_GROUP__ITEMS, ItemGroup.class, msgs);
		}
