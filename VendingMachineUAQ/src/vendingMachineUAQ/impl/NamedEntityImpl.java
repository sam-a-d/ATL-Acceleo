 ...
 * </p>
 * <ul>
 *   <li>{@link vendingMachineUAQ.impl.NamedEntityImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NamedEntityImpl extends MinimalEObjectImpl.Container implements NamedEntity {
	...
	protected EClass eStaticClass() {
		return VendingMachineUAQPackage.Literals.NAMED_ENTITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VendingMachineUAQPackage.NAMED_ENTITY__NAME, oldName, name));
	}
