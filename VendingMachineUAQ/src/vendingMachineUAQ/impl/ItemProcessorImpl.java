...
public class ItemProcessorImpl extends HasOperationImpl implements ItemProcessor {
		...
		if (state != null && state.eIsProxy()) {
			...
			if (state != oldState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VendingMachineUAQPackage.ITEM_PROCESSOR__STATE, oldState, state));
			}
		}
		return state;
	}
	...
	public void setState(State newState) {
		...
		state = newState;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VendingMachineUAQPackage.ITEM_PROCESSOR__STATE, oldState, state));
	}
	...
	public void setCurrentStage(STATES newCurrentStage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VendingMachineUAQPackage.ITEM_PROCESSOR__CURRENT_STAGE, oldCurrentStage, currentStage));
	}
