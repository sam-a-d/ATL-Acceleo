...
public class LocationImpl extends NamedEntityImpl implements Location {
	...
	public void setLong(float newLong) {
		...
		long_ = newLong;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VendingMachineUAQPackage.LOCATION__LONG, oldLong, long_));
	}
	...
	public boolean ValidCoordinates(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, VendingMachineUAQPackage.Literals.LOCATION___VALID_COORDINATES__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				try {
					...
					try {
						...
						final /*@NonInvalid*/ IntegerValue diff = (IntegerValue)NumericNegateOperation.INSTANCE.evaluate(VendingMachineUAQTables.INT_90);
						final /*@NonInvalid*/ boolean ge = OclComparableGreaterThanEqualOperation.INSTANCE.evaluate(executor, BOXED_lat_0, diff).booleanValue();
						final /*@NonInvalid*/ Boolean and;
						if (!ge) {
							and = ValueUtil.FALSE_VALUE;
						}
						else {
							final /*@NonInvalid*/ boolean le_0 = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, BOXED_lat_0, VendingMachineUAQTables.INT_90).booleanValue();
							if (!le_0) {
								and = ValueUtil.FALSE_VALUE;
							}
							else {
						...
						if (and == ValueUtil.FALSE_VALUE) {
							...
							final /*@NonInvalid*/ IntegerValue diff_0 = (IntegerValue)NumericNegateOperation.INSTANCE.evaluate(VendingMachineUAQTables.INT_180);
							final /*@NonInvalid*/ boolean ge_0 = OclComparableGreaterThanEqualOperation.INSTANCE.evaluate(executor, BOXED_long1_0, diff_0).booleanValue();
							if (!ge_0) {
								and_0 = ValueUtil.FALSE_VALUE;
							}
							else {
					...
					if (CAUGHT_and_0 == ValueUtil.FALSE_VALUE) {
						...
						final /*@NonInvalid*/ boolean le_1 = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, BOXED_long1_0, VendingMachineUAQTables.INT_180).booleanValue();
						if (!le_1) {
							result = ValueUtil.FALSE_VALUE;
						}
						else {
				...
				final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, constraintName, this, (Object)null, diagnostics, context, (Object)null, severity_0, CAUGHT_result, VendingMachineUAQTables.INT_0).booleanValue();
				IF_le = logDiagnostic;
			}
			return IF_le;
		}
