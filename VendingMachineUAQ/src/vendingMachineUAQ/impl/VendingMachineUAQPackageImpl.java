...
public class VendingMachineUAQPackageImpl extends EPackageImpl implements VendingMachineUAQPackage {
	...
	public static VendingMachineUAQPackage init() {
		if (isInited) return (VendingMachineUAQPackage)EPackage.Registry.INSTANCE.getEPackage(VendingMachineUAQPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredVendingMachineUAQPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		VendingMachineUAQPackageImpl theVendingMachineUAQPackage = registeredVendingMachineUAQPackage instanceof VendingMachineUAQPackageImpl ? (VendingMachineUAQPackageImpl)registeredVendingMachineUAQPackage : new VendingMachineUAQPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEReference(getVendingMachine_Location(), this.getLocation(), null, "location", null, 0, 1, VendingMachine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getLocation_Lat(), ecorePackage.getEFloat(), "lat", null, 1, 1, Location.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLocation_Long(), ecorePackage.getEFloat(), "long", null, 1, 1, Location.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		EOperation op = initEOperation(getLocation__ValidCoordinates__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "ValidCoordinates", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getKeypad_Input(), ecorePackage.getEString(), "input", null, 0, 1, Keypad.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(hasOperationEClass, HasOperation.class, "HasOperation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getHasOperation_Operation(), this.getSTATE_OPERATIONS(), "operation", null, 0, 1, HasOperation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getItemProcessor_CurrentStage(), this.getSTATES(), "currentStage", null, 1, 1, ItemProcessor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPaymentProcessor_Amound(), ecorePackage.getEFloat(), "amound", null, 1, 1, PaymentProcessor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPaymentProcessor_PaymentMethod(), this.getPAYMENT_METHODS(), "paymentMethod", null, 1, 1, PaymentProcessor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEOperation(getPaymentProcessor__IsPaymentComplete(), ecorePackage.getEBoolean(), "isPaymentComplete", 1, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getItemGroup_Image(), ecorePackage.getEString(), "image", null, 1, 1, ItemGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getItemGroup_Items(), this.getItem(), this.getItem_ItemGroup(), "items", null, 0, -1, ItemGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getItemGroup__PositiveQuantity__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "PositiveQuantity", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getItem_ItemGroup(), this.getItemGroup(), this.getItemGroup_Items(), "itemGroup", null, 1, 1, Item.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(inventoryEClass, Inventory.class, "Inventory", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getInventory_ItemGroups(), this.getItemGroup(), null, "itemGroups", null, 0, -1, Inventory.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getInventory_Capacity(), ecorePackage.getEInt(), "capacity", null, 1, 1, Inventory.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getInventory_AvailableSlots(), ecorePackage.getEInt(), "availableSlots", null, 1, 1, Inventory.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getInventory__CalculateTotalValue(), ecorePackage.getEFloat(), "calculateTotalValue", 1, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getInventory__NonNegativeCapacity__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "NonNegativeCapacity", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (itemGroupEClass,
		   source,
		   new String[] {
			   "constraints", "PositiveQuantity"
		   });
		addAnnotation
		  (inventoryEClass,
		   source,
		   new String[] {
			   "constraints", "NonNegativeCapacity"
		   });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (getLocation__ValidCoordinates__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.lat >= -90 and self.lat <= 90 and self.long >= -180 and self.long <= 180"
		   });
		addAnnotation
		  (getPaymentProcessor__IsPaymentComplete(),
		   source,
		   new String[] {
			   "body", "self.state.stage = STATES::PROCESSING_PAYMENT and not self.paymentMethod.oclIsUndefined()"
		   });
		addAnnotation
		...
		addAnnotation
		  (getInventory__CalculateTotalValue(),
		   source,
		   new String[] {
			   "body", "self.itemGroups->collect(g | g.quantity * g.price)->sum()"
		   });
		addAnnotation
		  (getInventory__NonNegativeCapacity__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.capacity >= 0"
		   });
	}
