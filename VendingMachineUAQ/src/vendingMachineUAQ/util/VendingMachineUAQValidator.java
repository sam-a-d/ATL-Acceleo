...
public class VendingMachineUAQValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	public boolean validateVendingMachine(VendingMachine vendingMachine, DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public boolean validateLocation(Location location, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateLocation_ValidCoordinates(location, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateLocation_ValidCoordinates(Location location, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateHasOperation(HasOperation hasOperation, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateItemProcessor(ItemProcessor itemProcessor, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validatePaymentProcessor(PaymentProcessor paymentProcessor, DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public boolean validateItemGroup(ItemGroup itemGroup, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(itemGroup, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(itemGroup, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(itemGroup, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(itemGroup, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(itemGroup, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(itemGroup, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(itemGroup, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(itemGroup, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(itemGroup, diagnostics, context);
		if (result || diagnostics != null) result &= validateItemGroup_PositiveQuantity(itemGroup, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateItemGroup_PositiveQuantity(ItemGroup itemGroup, DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public boolean validateInventory(Inventory inventory, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(inventory, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(inventory, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(inventory, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(inventory, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(inventory, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(inventory, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(inventory, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(inventory, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(inventory, diagnostics, context);
		if (result || diagnostics != null) result &= validateInventory_NonNegativeCapacity(inventory, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateInventory_NonNegativeCapacity(Inventory inventory, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateSTATE_OPERATIONS(STATE_OPERATIONS statE_OPERATIONS, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return true;
	}
	 ...
	 * @generated
	 */
	public boolean validatePAYMENT_METHODS(PAYMENT_METHODS paymenT_METHODS, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return true;
	}
