...
public interface VendingMachineUAQPackage extends EPackage {
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EOperation LOCATION___VALID_COORDINATES__DIAGNOSTICCHAIN_MAP = eINSTANCE.getLocation__ValidCoordinates__DiagnosticChain_Map();
		 ...
		 * @generated
		 */
		EOperation ITEM_GROUP___POSITIVE_QUANTITY__DIAGNOSTICCHAIN_MAP = eINSTANCE.getItemGroup__PositiveQuantity__DiagnosticChain_Map();
		 ...
		 * @generated
		 */
		EOperation INVENTORY___NON_NEGATIVE_CAPACITY__DIAGNOSTICCHAIN_MAP = eINSTANCE.getInventory__NonNegativeCapacity__DiagnosticChain_Map();
