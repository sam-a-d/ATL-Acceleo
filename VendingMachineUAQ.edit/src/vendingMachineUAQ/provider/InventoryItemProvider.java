...
public class InventoryItemProvider extends HasIdItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Inventory_capacity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Inventory_capacity_feature", "_UI_Inventory_type"),
				 VendingMachineUAQPackage.Literals.INVENTORY__CAPACITY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VendingMachineUAQPackage.Literals.INVENTORY__LAST_RESTOCKED,
				 true,
				 false,
				 false,
	...
	protected void addAvailableSlotsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Inventory_availableSlots_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Inventory_availableSlots_feature", "_UI_Inventory_type"),
				 VendingMachineUAQPackage.Literals.INVENTORY__AVAILABLE_SLOTS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VendingMachineUAQPackage.Literals.INVENTORY__ITEM_GROUPS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(VendingMachineUAQPackage.Literals.INVENTORY__ITEM_GROUPS,
				 VendingMachineUAQFactory.eINSTANCE.createItemGroup()));
	}
