		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_PaymentProcessor_amound_feature", "_UI_PaymentProcessor_type"),
				 VendingMachineUAQPackage.Literals.PAYMENT_PROCESSOR__AMOUND,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VendingMachineUAQPackage.Literals.PAYMENT_PROCESSOR__PAYMENT_METHOD,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VendingMachineUAQPackage.Literals.PAYMENT_PROCESSOR__STATE,
				 true,
				 false,
				 true,
				 null,
