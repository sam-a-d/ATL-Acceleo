		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VendingMachineUAQPackage.Literals.LOCATION__LAT,
				 true,
				 false,
				 false,
	...
	protected void addLongPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Location_long_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Location_long_feature", "_UI_Location_type"),
				 VendingMachineUAQPackage.Literals.LOCATION__LONG,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
