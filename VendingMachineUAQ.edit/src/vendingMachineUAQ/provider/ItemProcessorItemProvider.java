		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VendingMachineUAQPackage.Literals.ITEM_PROCESSOR__STATE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ItemProcessor_currentStage_feature", "_UI_ItemProcessor_type"),
				 VendingMachineUAQPackage.Literals.ITEM_PROCESSOR__CURRENT_STAGE,
				 true,
				 false,
				 false,
